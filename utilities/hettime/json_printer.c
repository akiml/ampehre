...
static void add_config(cJSON *config, ARGUMENTS *settings){
	...
	cJSON_AddNumberToObject(config_cpu, "skip_ms_rate", settings->skip_ms_rate_cpu);
	...
	cJSON_AddNumberToObject(config_gpu, "skip_ms_rate", settings->skip_ms_rate_gpu);
	...
	cJSON_AddNumberToObject(config_fpga, "skip_ms_rate", settings->skip_ms_rate_fpga);
	...
	cJSON_AddNumberToObject(config_system, "skip_ms_rate", settings->skip_ms_rate_mic);
	...
	cJSON_AddNumberToObject(config_mic, "skip_ms_rate", settings->skip_ms_rate_sys);
}
