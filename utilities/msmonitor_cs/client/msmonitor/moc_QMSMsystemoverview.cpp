...
void QMSMSystemOverview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QMSMSystemOverview *_t = static_cast<QMSMSystemOverview *>(_o);
        switch (_id) {
        case 0: _t->update((*reinterpret_cast< std::vector<double>(*)>(_a[1]))); break;
        case 1: _t->updatePID((*reinterpret_cast< std::vector<std::string>(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QMSMSystemOverview::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QMSMSystemOverview::staticMetaObject = {
    { &QMdiSubWindow::staticMetaObject, qt_meta_stringdata_QMSMSystemOverview,
      qt_meta_data_QMSMSystemOverview, &staticMetaObjectExtraData }
};
