...
**
** Created: Thu Mar 9 18:11:04 2017
...
static const char qt_meta_stringdata_QMSMSettings[] = {
    ...
    "signal_saveData(int)\0emit_start()\0"
    "emit_stop()\0v\0emit_guiRate(int)\0"
    "emit_dataPlot(int)\0emit_saveData(int)\0"
...
int QMSMSettings::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: emit_start(); break;
        case 6: emit_stop(); break;
        case 7: emit_guiRate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 8: emit_dataPlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 9: emit_saveData((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 10: setFreqLabels((*reinterpret_cast< std::vector<uint64_t>(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 11;
    }
