...
void CConfig::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CConfig *_t = static_cast<CConfig *>(_o);
        switch (_id) {
        case 0: _t->exportPlotToCSV((*reinterpret_cast< QMSMplot*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData CConfig::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CConfig::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CConfig,
      qt_meta_data_CConfig, &staticMetaObjectExtraData }
};
