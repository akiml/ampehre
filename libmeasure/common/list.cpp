...
void* allocMeasurement(int id) {
	...
	switch(id) {
		case CPU:
			...
			((MS_MEASUREMENT_CPU *)ms_measurement)->msr_check_for_exit_interrupts		= 1;
			break;
		case GPU:
			...
			((MS_MEASUREMENT_GPU *)ms_measurement)->nvml_check_for_exit_interrupts		= 1;
			break;
		case FPGA:
			...
			((MS_MEASUREMENT_FPGA *)ms_measurement)->maxeler_check_for_exit_interrupts	= 1;
			break;
		case MIC:
			...
			((MS_MEASUREMENT_MIC *)ms_measurement)->mic_check_for_exit_interrupts		= 1;
			break;
		case SYSTEM:
