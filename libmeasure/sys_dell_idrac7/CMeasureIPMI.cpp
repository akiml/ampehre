...
namespace NLibMeasure {
	...
	template <int SkipMs, int Variant>
	void CMeasureIPMI<SkipMs, Variant>::measure(void* pMsMeasurement, int32_t& rThreadNum) {
	...
	template <int SkipMs, int Variant>
	void CMeasureIPMI<SkipMs, Variant>::measureRecordIDs(MS_MEASUREMENT_SYS *pMsMeasurementSys, int32_t& rThreadNum) {
		double value = 0;
	...
	template <int SkipMs, int Variant>
	void CMeasureIPMI<SkipMs, Variant>::measureRawMsgs(MS_MEASUREMENT_SYS *pMsMeasurementSys, int32_t& rThreadNum) {
	...
	template <int SkipMs, int Variant>
	void CMeasureIPMI<SkipMs, Variant>::measureRawMsgDellCumulativeEnergy(MS_MEASUREMENT_SYS *pMsMeasurementSys, int32_t& rThreadNum) {
		int32_t completion_code;
	...
	template <int SkipMs, int Variant>
	void CMeasureIPMI<SkipMs, Variant>::measureRawMsgDellCurrentPower(MS_MEASUREMENT_SYS *pMsMeasurementSys, int32_t& rThreadNum) {	
		int32_t completion_code;		
